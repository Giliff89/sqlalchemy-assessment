...
class Brand(db.Model):
    ...
    def __repr__(self):
        ...
        return "<Brand brand_id=%s name=%s founded=%s>" % (self.brand_id, self.name, self.founded)
...
class Model(db.Model):
    ...
    def __repr__(self):
        ...
        return "<Model model_id=%s brand_id=%s name=%s year=%s>" % (self.model_id, self.brand_id, self.name, self.year)
